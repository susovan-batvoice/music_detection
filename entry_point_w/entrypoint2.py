'''
This is also the main() program, but it doesn't use foo, so basically it prepares all the data and MFCC coeff.s itself,
then builds model, then run tests
